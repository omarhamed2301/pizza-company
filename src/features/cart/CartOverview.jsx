...
function CartOverview() {
  ...
  return (
    <div className="d-flex justify-content-between bg-dark align-items-center py-2 px-5 cartOverview" style={{position:'fixed', width:'100%', bottom:'0', left:'0'}}>
      ...
      <Link
        to="/cart"
        className="text-decoration-none openCart"
